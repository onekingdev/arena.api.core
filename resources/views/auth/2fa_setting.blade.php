        ...
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Two factor authentication (2FA) strengthens access security by requiring two methods (also referred to as factors) to verify your identify. Two factor authentication protects
                        ...
                        @elseif(!$data["user"]->loginSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{route('enable')}}">
                                ...
                                <div class="form-group{{ $errors->has('verify-code') ? ' has-error' : '' }}">
                                    ...
                                    <input type="password" id="secret" class="form-control col-md-4" name="secret" required>
                        ...
                        @elseif($data["user"]->loginSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('disable') }}">
                                ...
                                <div class="form-group{{ $errors->has('current_password')? ' has-error' : '' }}">
                                    ...
                                    <input type="password" id="current_password" class="form-control col-md-4" name="current_password" required>
