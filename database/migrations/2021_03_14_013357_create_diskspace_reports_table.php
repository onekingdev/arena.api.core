...
class CreateDiskspaceReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("soundblock_reports_diskspace", function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists("soundblock_reports_diskspace");
    }
}
