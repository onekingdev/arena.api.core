...
class CreateApparelScrapingSizesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("apparel_scraping_sizes", function (Blueprint $table) {
            $table->bigIncrements("size_id")->index("idx_size-id");
            $table->uuid("size_uuid")->index("idx_size-uuid")->unique("uidx_size-uuid");
    ...
    {
        Schema::dropIfExists("apparel_scraping_sizes");
    }
}
