...
class SoundblockFilesMerch extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('soundblock_files_merch', function (Blueprint $objTable) {
            ...
            $objTable->string("file_sku", 50)->nullable();
            // $objTable->unsignedBigInteger("parent_row_id")->nullable();
    ...
    {
        Schema::dropIfExists('soundblock_files_merch');
    }
}
