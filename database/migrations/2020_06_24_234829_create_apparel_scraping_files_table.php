...
class CreateApparelScrapingFilesTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create('apparel_scraping_files', function (Blueprint $table) {
    ...
    public function down() {
        Schema::dropIfExists('apparel_scraping_files');
    }
}
