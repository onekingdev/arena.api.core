...
//                $userService->find($objRequest->user, true);
...
//                $objInvoice = InvoiceFacade::createInvoiceFor($objReceiver, $objAccountTransaction, Client::app(), $objRequest->invoice_type, $arrLineItem, Auth::user(), $options);
//
