                    ...
                    <table width="100%" style="border-spacing: 0; text-align: center;">
                        <tr>
                            <td style="padding: 20px 15px;">
                                <p style="font-size: 13px;color: #b6b6b6;font-weight: bold;">Arena {{ $app }} LLC<br/>21430 North 2nd Ave, STE 2<br/>Phoenix, AZ 85027, USA</p>
                                <p><a class="apparel" href="tel:6024669636"><font color="#518DC9"><span style='text-decoration:none;text-underline:none'>602-466-9636</span></font></a><br/>
                                    <a class="apparel" href="mailto:contact@arenamerch.com"><font color="#518DC9"><span style='text-decoration:none;text-underline:none'>arena@support.arena.com</span></font></a>
                                </p>
                            </td>
