...
class FinanceTypesTransactions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("finance_types_transactions", function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists("finance_types_transactions");
    }
}