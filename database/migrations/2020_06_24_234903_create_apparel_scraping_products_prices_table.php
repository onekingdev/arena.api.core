...
class CreateApparelScrapingProductsPricesTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create("apparel_scraping_products_prices", function (Blueprint $table) {
            $table->bigIncrements("row_id")->index("idx_row-id")->unique("idx_row-id");
            $table->uuid("row_uuid")->index("idx_row-uuid")->unique("idx_row-uuid");
    ...
    public function down() {
        Schema::dropIfExists("apparel_scraping_products_prices");
    }
}
