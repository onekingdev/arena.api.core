...
class SoundblockProjectsNotesAttachments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("soundblock_projects_notes_attachments", function (Blueprint $objTable) {
    ...
    {
        Schema::dropIfExists("soundblock_projects_notes_attachments");
    }
}
