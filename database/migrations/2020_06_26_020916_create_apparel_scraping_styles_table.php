...
class CreateApparelScrapingStylesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("apparel_scraping_styles", function (Blueprint $table) {
            $table->bigIncrements("style_id")->index("idx_style-id");
    ...
    {
        Schema::dropIfExists("apparel_scraping_styles");
    }
}
