...
class CreateContractHistoryTable extends Migration
{
    ...
    public function up()
    {
        Schema::dropIfExists("soundblock_projects_contracts_history");
        Schema::create("soundblock_projects_contracts_history", function (Blueprint $table) {
