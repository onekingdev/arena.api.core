...
class CreateApparelScrapingProductsStylesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("apparel_scraping_products_styles", function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists("apparel_scraping_products_styles");
    }
}
