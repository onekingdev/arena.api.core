...
class CreateApparelProductsStylesImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('apparel_products_styles_images', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('apparel_products_styles_images');
    }
}
