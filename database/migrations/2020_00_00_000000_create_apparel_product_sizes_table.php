...
class CreateApparelProductSizesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('apparel_products_sizes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('apparel_products_sizes');
    }
}
