...
class CreateSoundblockProjectsArtistsPrimariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("soundblock_projects_artists_primary", function (Blueprint $objTable) {
    ...
    {
        Schema::dropIfExists("soundblock_projects_artists_primary");
    }
}
