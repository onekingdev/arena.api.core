...
class CreateBandwidthMonthlyReportsTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create("soundblock_reports_bandwidth_monthly", function (Blueprint $table) {
    ...
    public function down() {
        Schema::dropIfExists("soundblock_reports_bandwidth_monthly");
    }
}
