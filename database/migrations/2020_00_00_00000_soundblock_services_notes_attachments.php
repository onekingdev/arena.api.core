...
class SoundblockServicesNotesAttachments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("soundblock_services_notes_attachments", function (Blueprint $objTable) {
    ...
    {
        Schema::dropIfExists("soundblock_services_notes_attachments");
    }
}
