...
class CreateApparelProductPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('apparel_products_prices', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('apparel_products_prices');
    }
}
